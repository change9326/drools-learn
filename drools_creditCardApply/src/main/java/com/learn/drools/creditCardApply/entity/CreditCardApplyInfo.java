package com.learn.drools.creditCardApply.entity;

/**
 * @author yujiaqi
 * @date 2020-07-14 11:55
 * @description
 */
public class CreditCardApplyInfo {
    ...
    private double monthlyIncome = 0;//⽉收⼊
    private String address;
    private boolean hasHouse = false;//是否有房
    private boolean hasCar = false;//是否有⻋
    private int hasCreditCardCount = 0;//现持有信⽤卡数量
